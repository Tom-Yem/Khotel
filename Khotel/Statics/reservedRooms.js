let showReserved = document.getElementById('btn');
showReserved.onclick = async function(){
...
let unreserveRoom = document.getElementById('unreserve');
unreserveRoom.onclick = async function(){
